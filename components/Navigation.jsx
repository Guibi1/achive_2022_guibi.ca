...
export default function Navigation() {
    ...
    return (
        <nav
            onMouseEnter={() => {
                if (!noHover) openNavigation();
            }}
            onMouseLeave={() => {
                if (!noHover) closeNavigation();
            }}
            className={style.nav}
            ref={nav}
        >
            <ul className={style.ul}>
                    ...
                    <Link href="/">
                        <a onClick={handleLogoClick} className={`${style.a} ${style.logo}`}>
                            ...
                            <svg
                                ...
                                className={`${style.svg} ${style.logo}`}
                                aria-hidden="true"
                                focusable="false"
                                data-prefix="fad"
                    ...
                    svg={
                        ...
                        >
                            <g className="group">
                                <path
                                    fill="currentColor"
                                    d="M480 0H32A32 32 0 0 0 0 32v448a32 32 0 0 0 32 32h448a32 32 0 0 0 32-32V32a32 32 0 0 0-32-32zm-31.8 448H64v-96h.2v-96H64v-96h.2V64h384z"
                                    className={style.dark}
                                ></path>
                                <path
                                    fill="currentColor"
                ...
                <li className={style.social}>
                    <a href="https://github.com/Guibi1" target="_blank" rel="noreferrer" onClick={closeNavigation} className={style.a}>
                        <svg
                            className={style.svg}
                            aria-hidden="true"
                            focusable="false"
                    ...
                    <a href="https://gitlab.com/Guibi" target="_blank" rel="noreferrer" onClick={closeNavigation} className={style.a}>
                        <svg
                            className={style.svg}
                            aria-hidden="true"
                            focusable="false"
                    ...
                    <a href="https://www.instagram.com/laurent.stephenne/" target="_blank" rel="noreferrer" onClick={closeNavigation} className={style.a}>
                        <svg
                            className={style.svg}
                            aria-hidden="true"
                            focusable="false"
...
function Dropdown(props) {
    ...
    for (let item of props.children) if (router.pathname.startsWith(item.props.url)) className = `${style.li} ${style.dropdown} ${style.current}`;
...
function closeNavigation() {
    ...
    // Close all dropdowns
    for (let dropdown of nav.current.getElementsByClassName(`${style.li} ${style.dropdown} ${style.open}`)) dropdown.classList.remove(style.open);
}
...
function handleDropdownClick(e) {
    ...
    if (li.classList.toggle(style.open)) openNavigation();
}
...
function handleLogoClick(e) {
    ...
    if (nav.current.classList.toggle(style.open)) e.preventDefault();
}
