            ...
            <ul className={style.ul}>
                ...
                <li className={style.social}>
                    <div className={style.divSocial}>
                        <a href="https://github.com/Guibi1" target="_blank" onClick={closeNavigation} className={style.a}>
                        ...
                        <a href="https://gitlab.com/Guibi" target="_blank" onClick={closeNavigation} className={style.a}>
                        ...
                        <a href="https://www.instagram.com/laurent.stephenne/" target="_blank" onClick={closeNavigation} className={style.a}>
