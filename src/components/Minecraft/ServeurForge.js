    ...
    render()
    {
        return (
            <Container style={{display: "block", justifyContent: "center", textAlign: "center"}}>
                ...
                <YouTube videoId="BxL9kIrhruE" opts={{ playerVars: {autoplay: 0} }} className="youtubePlayer"/>
                ...
                <Paper style={{maxWidth: "800px", margin: "auto"}}>
                    ...
                    <SwipeableViews axis={'x'} index={this.state.tabValue}>
                        <div role="tabpanel" hidden={this.state.tabValue !== 0} dir={'x'} style={{margin: "15px", minHeight: "220px"}}>
                            ...
                            <Button variant="outlined" onClick={() => this.handleCopy("https://guibi.ca/files/configServeurForge.zip")} style={{margin: "10px"}}>Copier l'adresse</Button>
                            <span style={{display: 'flex', justifyContent: "center"}}>
                                <ArrowList fontSize="small"/>
                        ...
                        <div role="tabpanel" hidden={this.state.tabValue !== 1} dir={'x'} style={{margin: "15px", minHeight: "220px"}}>
                            <span style={{display: 'flex', justifyContent: "center"}}>
                                <ArrowList fontSize="small"/>
                            ...
                            <Button variant="outlined" onClick={this.handleDownload} style={{margin: "10px"}}>Télécharger les mods</Button>
                            <span style={{display: 'flex', justifyContent: "center"}}>
                                <ArrowList fontSize="small"/>
                            ...
                            <Button variant="outlined" onClick={() => this.handleCopy("minecraft.guibi.ca")} style={{margin: "10px"}}>Copier l'adresse</Button>
                        </div>
                    </SwipeableViews>
                </Paper>
