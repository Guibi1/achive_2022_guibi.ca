...
export default function Calcul() {
    return (
        <div className="page">
            ...
            <div className="section gray">
                <div className="grid">
                    <div className="text">
                        ...
                        <p>
                            Calcul est un programme qui fait pratiquer les tables d&apos;opérations mathématiques d&apos;une façon intuitive et facile. Avec son
                            interface simplifiée, il convient aux jeunes comme aux grands.
                        </p>
            ...
            <div className="section">
                <div className="grid">
                    ...
                    <div className="purple-border text">
                        <h2>Paramètres</h2>
                        <p>
                            Grâce à la page des paramètres, vous pouvez aisément changer les opérateurs de calcul choisis, le nombre de questions et tous les
                            autres paramètres.
                        </p>
                        <p>
                            De plus, pour vous éviter de devoir choisir vos paramètres à chaque fois que vous voulez pratiquer vos tables, Calcul peut
                            sauvegarder vos préférences pour la prochaine fois !!!
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="section">
                <button type="button" onClick={handleDownload} className="big">
                    Télécharger Calcul
                </button>
            </div>
        </div>
